...
for(yR in years) { 
  ...
  predictedTemps <- data.table(ChannelMile = out.p$x, Value = out.p$z)
...
the warmer surface 
water is drawn closer to 
the power intakes that 
...
gif_file <- gifski(imgs, width = 4800, height = 2700, delay = .5, loop = TRUE,
