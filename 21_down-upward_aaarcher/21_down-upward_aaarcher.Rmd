...
# Create subset for plotting dates
...
ggdraw(ylim = c(0,1), # 0-1 scale makes it easy to place viz items on canvas
  ...
  draw_label("el Niño",
             ...
             color = elnino_dark,
             size = 60) +
  draw_label("Wetter weather in the Southern U.S.\nand drier weather in the North.",
             x = 0.55,
             y = 0.93,
             hjust = 0,
             vjust = 1,
             ...
             color = "#36454F",
             size = 24) +
  geom_curve(aes(x = 0.775, xend = 0.86,
                 y = 0.85, yend = 0.80),
             curvature = 0.2,
             linewidth = 0.5,
             color = "#36454F", 
  ...
  draw_label("la Niña",
             ...
             color = lanina_dark,
             size = 60) +
    draw_label("Drier weather in the Southern U.S.\nand wetter weather in the North.",
             x = 0.40,
             y = 0.21,
             hjust = 0,
             vjust = 1,
             ...
             color = "#36454F",
             size = 24) +
  geom_curve(aes(x = 0.460, xend = 0.54,
                 y = 0.225, yend = 0.35),
             curvature = -0.2,
             linewidth = 0.5,
             color = "#36454F", 
