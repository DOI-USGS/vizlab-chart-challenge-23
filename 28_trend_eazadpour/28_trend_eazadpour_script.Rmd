...
arrow_fxn <- function(data, state, x, y ,y_end, curve, color){
      geom_segment(data = data |> filter(name %in% state),
                  aes(x = x,
                  xend = x, 
                  y = y,
                  yend = y_end),
...
(main_plot <- ggplot(my_grid_dropWI, aes(x = year, y = forest_diff)) +
  ...
  # add positive arrow for 1995 positive difference in TX
    arrow_fxn(my_us_grid_dropWI, c("Texas"), 1995, 0, 5000, 1.5, postive_col) +
    # add negative arrows for 2011-2014 TX
    arrow_fxn(my_us_grid_dropWI, c("Texas"), 2011, 0, -5000, -1.5, negative_col) +
    arrow_fxn(my_us_grid_dropWI, c("Texas"), 2012, 0, -5000, -1.5, negative_col) +
    arrow_fxn(my_us_grid_dropWI, c("Texas"), 2013, 0, -5000, -1.5, negative_col) +
    arrow_fxn(my_us_grid_dropWI, c("Texas"), 2014, 0, -5000, -1.5, negative_col) +
  # add negative arrows for 2018-2020 CA
    arrow_fxn(my_us_grid_dropWI, c("California"), 2018, 0, -5000, -1.5, negative_col) +
    arrow_fxn(my_us_grid_dropWI, c("California"), 2019, 0, -5000, -1.5, negative_col) +
    arrow_fxn(my_us_grid_dropWI, c("California"), 2020, 0, -5000, -1.5, negative_col) +
...
final_plt <- custom_plt +
    annotation_custom(rasterGrob(oak_opacity, 
                               ...
                               height = unit(1,"npc")), 
                    0.6, 1.21, -Inf, 1.5) +
      annotation_custom(rasterGrob(pine_opacity, 
                               width = unit(1,"npc"), 
                               height = unit(1,"npc")), 
                    -0.18, 0.28, 0, 1.5)
