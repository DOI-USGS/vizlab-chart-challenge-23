...
# test <- readNWISsite("01467200")
# test2 <- whatNWISdata(siteNumber = "01467200", service = "dv", parameterCd = "00010")
# 
# temp_data_test <- readNWISdv("01467200", "00010", "", "", "00003")
...
#extract axis from this plot:
# (template_plot <- ggplot(temp_data_avg, 
...
#     #scale_colour_scico(palette = "devon")+
...
#           axis.text.x = element_text(angle = 45, vjust = 0.3, hjust=0.5),
#           axis.title = element_text(size = 16),
#           axis.title.x = element_text(vjust = -0.06),
...
# 
# x_axis <- get_x_axis(template_plot)
# y_axis <- get_y_axis(template_plot)
# legend <- get_legend(template_plot)
