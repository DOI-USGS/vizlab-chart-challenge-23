...
pop_color = "#36A19F"#"#73A9AD"#"#e05915"
...
(map_plot <- ggplot(data = states_CASC) +
    geom_sf(fill = pop_color, color = background_color, linewidth = 0.4) +
    ...
    geom_segment(aes(x = -125, xend = -127, # northwest
                 ...
                 color = pop_color, linewidth = 1.3, lineend = "round")+
...
ggdraw(ylim = c(0,1), # 0-1 scale makes it easy to place viz items on canvas
  ...
  # Title
  draw_label("These are the 2000 most severe streamflow droughts\nat gages from 1920 to 2020 by time of year, decade, and region.",
             x = Xmargin,
             y = 1 - 3*Ymargin ,
             hjust = 0,
             vjust = 1,
