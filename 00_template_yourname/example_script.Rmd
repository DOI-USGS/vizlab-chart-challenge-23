...
> Note: The hardest part of this process is getting text to be the optimum size in the final `png` for Twitter. The font sizes here will **not** be the same as in the final image after the cowplot step. Make sure to check the output `png` and the final plot in the `html` for true font sizing. 
...
usgs_logo <- magick::image_read("../usgs_logo.png") 
