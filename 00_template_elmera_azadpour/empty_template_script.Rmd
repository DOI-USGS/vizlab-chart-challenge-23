...
plt <- ggplot(data, aes(values = ratio, fill = bins)) +
  ...
  scale_fill_manual(name=NULL, values = c("#37402a", "#798c5b","#b9c5a6"), breaks=c('high', 'moderate', 'low'),
                    labels = c("High concentration", "Moderate concentration", "Low concentration")) +
  labs(
