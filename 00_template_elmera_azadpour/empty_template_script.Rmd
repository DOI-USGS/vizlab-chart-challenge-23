...
plt <- threshold_decadal_gw_reg_grp |> 
  ...
  scale_fill_manual(name=NULL, values = c('#3A3A3A', "#808080","#BDBDBD"), breaks=c('high', 'moderate', 'low'),
...
# Main plot
# CHANGE CONSTITUENT HERE 
# For the purposes of this markdown, I'm just displaying one constituents regional varation. Final plot with small multiples is craeted in illustrator due to faceting bug. 
