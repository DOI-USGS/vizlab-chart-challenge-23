...
ggdraw(ylim = c(0,1), # 0-1 scale makes it easy to place viz items on canvas
  ...
  draw_label(paste('1 square =','1 billion gallons','per day', sep = "\n"),
             ...
             color = font_color) +
  # label thermo
  draw_label(wu_category_order[[1]],
             fontfamily = annotation_font,
             x = 0.26,   
             y = 0.8, 
             size = annotation_font_size,
             ...
             color = font_color) +
  # label irrigation
  draw_label(wu_category_order[[2]],
             fontfamily = annotation_font,
             x = 0.515,   
             y = 0.8, 
             size = annotation_font_size,
  ...
  geom_curve(aes(xend = 0.685, x = 0.715,
             ...
             color = font_color,
             lineend = 'round') +
  draw_label(wu_category_order[[3]],
             fontfamily = annotation_font,
             x = 0.722,   
             y = 0.89, 
             size = annotation_font_size,
  ...
  geom_curve(aes(xend = 0.75, x = 0.775,
             ...
             color = font_color,
             lineend = 'round') +
  draw_label(wu_category_order[[4]],
             fontfamily = annotation_font,
             x = 0.782,   
             y = 0.83, 
             size = annotation_font_size,
  ...
  geom_curve(aes(xend = 0.81, x = 0.85,
             ...
             color = font_color,
             lineend = 'round') +
  draw_label(wu_category_order[[5]],
             fontfamily = annotation_font,
             x = 0.83,   
             y = 0.755, 
             size = annotation_font_size,
  ...
  geom_curve(aes(xend = 0.85, x = 0.89,
             ...
             color = font_color,
             lineend = 'round') +
  draw_label(wu_category_order[[6]],
             fontfamily = annotation_font,
             x = 0.87,   
             y = 0.35, 
             size = annotation_font_size,
  ...
  geom_curve(aes(xend = 0.865, x = 0.905,
             ...
             color = font_color,
             lineend = 'round') +
  draw_label(stringr::str_wrap(wu_category_order[[7]], 20),
             fontfamily = annotation_font,
             x = 0.885,   
             y = 0.51, 
             size = annotation_font_size,
  ...
  geom_curve(aes(xend = 0.88, x = 0.92,
             ...
             color = font_color,
             lineend = 'round') +
  draw_label(wu_category_order[[8]],
             fontfamily = annotation_font,
             x = 0.9,   
             y = 0.665, 
             size = annotation_font_size,
  ...
  draw_label("National water use data: https://waterdata.usgs.gov/nwis/wu",
             ...
             color = font_color)+
  # Title
  draw_label("Annual U.S. water use - 2015",
             x = 0.04,
             y = 0.9,
             hjust = 0,
             vjust = 0,
