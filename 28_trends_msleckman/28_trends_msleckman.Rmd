...
## saving locally
ggsave(plot = main_map,'out/LT_map_gauges.png', width = 9, height = 9, dpi = 300)
...
## quick outputing of simple full histoical plot of streamflow (filtered only to Monday to make plot less busy time series - still need to work on on smoothing)  
