...
lt_map <- ggplot()+
  ...
  lt_map_segs <- lt_map + 
    ...
    geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[1]][1] - 0.015, xend = active_nwis_sites_lake_tahoe$geometry[[1]][1] - 0.1, 
                     y = active_nwis_sites_lake_tahoe$geometry[[1]][2] + 0.01, yend = active_nwis_sites_lake_tahoe$geometry[[1]][2] + 0.07),
    ...
    #
      geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[2]][1] - 0.015, xend = active_nwis_sites_lake_tahoe$geometry[[2]][1] - 0.1, 
                     y = active_nwis_sites_lake_tahoe$geometry[[2]][2], yend = active_nwis_sites_lake_tahoe$geometry[[2]][2]), 
                 arrow = arrow(length = unit(0.03, "npc")),
                 arrow.fill = "#354658", alpha = 0.4)+
    #
      geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[3]][1] - 0.015, xend = active_nwis_sites_lake_tahoe$geometry[[3]][1] - 0.15, 
                 ...
                 arrow.fill = "#354658", alpha = 0.4)+
    #
      geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[4]][1]-0.015, xend = active_nwis_sites_lake_tahoe$geometry[[4]][1] - 0.27, 
                     y = active_nwis_sites_lake_tahoe$geometry[[4]][2]- 0.006, yend = active_nwis_sites_lake_tahoe$geometry[[4]][2] - 0.1 ), 
                 arrow = arrow(length = unit(0.03, "npc")),
                 arrow.fill = "#354658", alpha = 0.4)+
    # 
     geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[5]][1] + 0.015, xend = active_nwis_sites_lake_tahoe$geometry[[5]][1] + 0.11, 
                     y = active_nwis_sites_lake_tahoe$geometry[[5]][2], yend = active_nwis_sites_lake_tahoe$geometry[[5]][2] - 0.05), 
                 arrow = arrow(length = unit(0.03, "npc")),
                 arrow.fill = "#354658", alpha = 0.4)+
    #
      geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[6]][1] + 0.015, xend = active_nwis_sites_lake_tahoe$geometry[[6]][1] + 0.07, 
                     y = active_nwis_sites_lake_tahoe$geometry[[6]][2], yend = active_nwis_sites_lake_tahoe$geometry[[6]][2] - 0.03), 
                 arrow = arrow(length = unit(0.03, "npc")),
                 arrow.fill = "#354658", alpha = 0.4)+
    # 
      geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[7]][1] + 0.015, xend = active_nwis_sites_lake_tahoe$geometry[[7]][1] + 0.04, 
                     y = active_nwis_sites_lake_tahoe$geometry[[7]][2], yend = active_nwis_sites_lake_tahoe$geometry[[7]][2]), 
                 arrow = arrow(length = unit(0.03, "npc")),
                 arrow.fill = "#354658", alpha = 0.4)+
    # 
      geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[8]][1] + 0.015, xend = active_nwis_sites_lake_tahoe$geometry[[8]][1] + 0.05, 
                     y = active_nwis_sites_lake_tahoe$geometry[[8]][2] - 0.005, yend = active_nwis_sites_lake_tahoe$geometry[[8]][2] - 0.01), 
                 arrow = arrow(length = unit(0.03, "npc")),
                 arrow.fill = "#354658", alpha = 0.4)+
      geom_segment(aes(x = active_nwis_sites_lake_tahoe$geometry[[9]][1], xend = active_nwis_sites_lake_tahoe$geometry[[9]][1] + 0.04, 
                       y = active_nwis_sites_lake_tahoe$geometry[[9]][2] + 0.015, yend = active_nwis_sites_lake_tahoe$geometry[[9]][2] + 0.08), 
                   arrow = arrow(length = unit(0.03, "npc")),
                   arrow.fill = "#354658", alpha = 0.4)
...
ggdraw(ylim = c(0,1), # 0-1 scale makes it easy to place viz items on canvas
  ...
  draw_label("Explainer text",
             ...
             color = font_color)+
  # Title
  draw_label("The 'Big Melt' has just begun.\nHow much snowmelt\nis flowing into Lake Tahoe?",
             x = 0.04,
             y = 0.985,
             hjust = 0,
             vjust = 1,
