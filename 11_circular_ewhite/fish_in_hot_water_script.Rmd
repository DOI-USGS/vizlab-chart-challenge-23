...
# library(ggnewscale)
# ggplot() + 
#   geom_segment(data = fish_data_wide[fish_data_wide$period == "Historical", ], aes(x = onset, xend = cessation, y = y_offset, yend = y_offset, col = onset_ci), alpha = 0.7, linewidth = 8 , show.legend = FALSE) + 
#   scale_colour_gradientn(colours = c("grey", "black")) +
#   new_scale_colour() +
#   geom_segment(data = fish_data_wide[fish_data_wide$period == "Future", ], aes(x = onset, xend = cessation, y = y_offset, yend = y_offset, col = cessation_ci), alpha = 0.7, linewidth = 8 , show.legend = FALSE) + 
#   scale_colour_gradientn(colours = c("yellow", "#815aa5")) +
...
ggplot(data = fish_data_wide) + 
  geom_segment(aes(x = onset, xend = cessation, y = y_offset, yend = y_offset, col = period), alpha = 0.7, linewidth = 8 , show.legend = FALSE) + 
  scale_color_manual(values = c("grey70", "#815aa5")) +
  scale_x_date(limits = c(as.Date("2015-01-01"), as.Date("2015-12-31")), date_breaks = "1 month", date_minor_breaks = "1 week", date_labels = "%B") +
  scale_y_continuous(limits = c(0, 13)) +
  coord_polar(theta = "x", direction = 1, start = -1.57*1.5) + # start is in radians, 90 Deg is Jan
  facet_wrap(~species) +
